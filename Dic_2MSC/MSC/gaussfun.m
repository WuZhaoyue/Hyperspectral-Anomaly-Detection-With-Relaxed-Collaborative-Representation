...
% Copyright 2015 Han Gong, University of East Anglia
    ...
    persistent ns; ns= 1000; % resolution of guassian approximation
    persistent xs; xs = linspace(0,bandWidth,ns+1); % approximate ticks
    persistent kfun; kfun= exp(-(xs.^2)/(2*bandWidth^2));
